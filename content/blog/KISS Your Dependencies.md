...
{{< infobox title="Lesson 1" >}}
Dependencies can increase the barrier of entry even for other engineers skilled in the implementation language.
{{< /infobox>}}
...
{{<infobox title="Lesson 2">}}
The barrier to entry cost may be paid more than once.
{{</infobox>}}
...
{{<infobox title="Lesson 3">}}
Use the primitives first. Then reach for dependencies if you truly TRULY need them.
{{</infobox>}}
